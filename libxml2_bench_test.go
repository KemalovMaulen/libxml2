...
import (
	...
	"github.com/KemalovMaulen/libxml2/dom"
...
type Foo struct {
	XMLName xml.Name `xml:"https://github.com/KemalovMaulen/libxml2/foo foo:foo"`
	Field1  string
...
func BenchmarkLibxml2DOM(b *testing.B) {
	var buf bytes.Buffer
	const nsuri = `https://github.com/KemalovMaulen/libxml2/foo`
	f := Foo{
		Field1: "Hello, World!",
		Field2: "Hello, Attribute!",
	}
